"""SQLAlchemy 2 ORM model for the relationship_artifact_provenance table."""
...
class RelationshipArtifactProvenanceModel(Base):
    """SQLAlchemy ORM model mapping to the 'relationship_artifact_provenance' PostgreSQL table."""

    __tablename__ = "relationship_artifact_provenance"
    __table_args__ = (
        UniqueConstraint("relationship_id", "artifact_id", name="uq_relationship_provenance_rel_artifact"),
    )
    ...
    @classmethod
    def from_domain(
        cls, provenance: GraphProvenance, relationship_id: uuid.UUID, user_id: uuid.UUID
